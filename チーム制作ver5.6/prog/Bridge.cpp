...
{
	// ポジションの初期化
	pos = VGet(600.0f, -10.0f, 0.0f);
	gPos = VGet(1100.0f, -10.0f, 0.0f);
	...
	gateModelHandle = MV1LoadModel("data/ゴールゲート/ゴールゲート.pmx");
...
void Bridge::Draw(const VECTOR player_x)
{
	...
	MV1SetRotationXYZ(bridgeModelHandle, VGet(0.0f, 180.0f * DX_PI_F / 180.0f, 0.0f));
